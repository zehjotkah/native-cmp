...
| Asset `webstudio-native-cmp-logo.svg` | Brand logo in the Site Header (Image component, token `site-logo`: 48 px, 40 px on phones). Cropped copy of `assets/source/Native_CMP_Logo_Two_Line.svg`, kept as `assets/native-cmp-logo-two-line.svg`. |
